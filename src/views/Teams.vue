<template>
    <section class="title-ornaments pb-16 -mt-4">
        <div class="container mx-auto md:px-6">
            <h4 class="text-center font-origin font-bold text-gray-600 uppercase">Teams</h4>
            <div class="flex flex-wrap justify-center gap-1 pt-5 pb-11">
                <div v-for="team in teams" :key="team.id" class="relative w-full mx-3 md:max-w-[95px] m-2"
                    style="filter: drop-shadow(0 0.2rem 0.25rem rgba(0, 0, 0, 0.35));">
                    <a :href="team.link">
                        <div :class="['hidden md:block z-10 absolute w-full text-white text-md font-bold py-2 text-center mt-3',
                            team.isSpecial
                        ...
                        <span v-if="team.isSpecial"
                            class="absolute top-8 md:top-8 z-20 left-16 md:left-auto md:right-[6px] w-[40px] aspect-[5/3] bg-[url('/orns/orn-teams.png')] bg-cover bg-no-repeat"></span>
                        <div :class="[
                            ...
                            <div :class="[
                                ...
                                <div
                                    ...
                                    <div :class="['block md:hidden relative w-full text-white text-sm min-w-24 py-1 text-center mt-3 -ml-1',
                                        team.isSpecial
                                            ? 'bg-gradient-to-r from-[#754c36] via-[#b27e52] to-[#754c36]'
                                            : 'bg-[#640000]'
                                    ]">
                                    ...
                                    <img v-if="team.isSpecial" src="/logo/logo-m6-color.png" alt="M6 Logo"
                        ...
                        <div class="relative text-center mt-2 font-bold text-base"
